...
export class Static_Colorful  extends ModeParameter{

    showSPBTable:any=[true, true, false];
    colorVisibleNum=4;
    constructor(){
        super();
        this.name="Static Colorful";
        this.colors=this.rainbow7Color();
        //this.colors= ['#FF0000', '#FF7D00','#FFFF00','#00FF00','#0000FF','#00FFFF','#FF00FF','#FFFFFF'];
        this.setLEDVarDefault();
    }
...
export class Breathing_Colorful  extends ModeParameter{

    showSPBTable:any=[true, true, false];
    colorVisibleNum=4;
    constructor(){
        super();
        this.name="Breathing Colorful";
        this.colors=this.rainbow7Color();
        //this.colors= ['#FF0000', '#FF7D00','#FFFF00','#00FF00','#0000FF','#00FFFF','#FF00FF','#FFFFFF'];
        this.setLEDVarDefault();
    }
...
export class Breathing_Rainbow  extends ModeParameter{
    showSPBTable:any=[true, true, false];
    colorVisibleNum=0;
    constructor(){
        super();
        this.name="Breathing Rainbow";
        this.colors=this.rainbow7Color();
        //this.colors= ['#FF0000', '#FF7D00','#FFFF00','#00FF00','#0000FF','#00FFFF','#FF00FF','#FFFFFF'];
        this.setLEDVarDefault();
    }
    ...
    scheduleCreateData(GroupNumber) {
        ...
        switch (this.speed) {
            case 0:
                this.repeatTime = max;//by Breathing_Rainbow
                break;
            case 1:
