...
var UIColorPicker = (function UIColorPicker() {
	...
	function Color(color) {
		...
		if(color instanceof Color === true) {
			console.log("this.copy(color):"+color);
			this.copy(color);
			return;
		}
	...
	Color.prototype.copy = function copy(obj) {
		console.trace();
		console.log("Color.prototype.copy ");
	...
	function ColorPicker(node) {
		...
		// };		
		this.newInputComponent('H(Hue)', 'hue', this.inputChangeHue.bind(this));
		this.newInputComponent('S(Saturation)', 'saturation', this.inputChangeSaturation.bind(this));
		this.newInputComponent('V(Value)', 'value', this.inputChangeValue.bind(this));
		this.newInputComponent('L(lightness)', 'lightness', this.inputChangeLightness.bind(this));

		this.createAlphaArea();

		this.newInputComponent('R(red)', 'red', this.inputChangeRed.bind(this));
		this.newInputComponent('G(green)', 'green', this.inputChangeGreen.bind(this));
		this.newInputComponent('B(blue)', 'blue', this.inputChangeBlue.bind(this));
	...
	ColorPicker.prototype.createPickingArea = function createPickingArea() {
		...
		var CB=this.updateColor.bind(this);
		console.log("createPickingArea:~~~~~~~~~~~"+CB);
	...
	ColorPicker.prototype.inputChangeSaturation = function inputChangeSaturation(e) {
	    console.trace();
		var value = parseInt(e.target.value);
		console.log("inputChangeSaturation_________:"+value);
    ...
    //all ui used for on class add effect 
	var init = function init() {
		...
		var t1elem = document.querySelectorAll('.t1');
		var t1size = t1elem.length;
		for (var i = 0; i < t1size; i++){
			new ColorPicker(t1elem[i]);
			
		}
        

		// var elem2 = document.getElementsByClassName('T1');//louis
		// var elem3 = document.getElementsByClassName('T1');//louis
		// console.log(elem2);
		// new ColorPicker(elem2);
