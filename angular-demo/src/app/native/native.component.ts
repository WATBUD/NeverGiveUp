...
export class NativeComponent implements OnInit {
  ...
  ngAfterViewInit() {
    ...
    var iframe2:any = document.getElementById('embedIframe');
    console.log('%c iframe2', 'background: blue; color: red', iframe2)

    iframe2.contentWindow.designMode = "on";
    iframe2.contentWindow.document.addEventListener('keyup', frameKeyUp);
